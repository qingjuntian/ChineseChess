...
interface IEngine {
	...
	public static final int ACTION_START = 32;
	public static final int ACTION_CHANGE_SEAT = 64;
...
public class Engine {
	...
	protected IEngineEventListener listener;
	 ...
	 * @param message
	 * @param withNotify
	 *            Whether need a toast or dialog to show notify this message 0:
	 *            Don't need any prompt 1: Use toast to prompt 2: Use dialog to
	 *            prompt
	 */
